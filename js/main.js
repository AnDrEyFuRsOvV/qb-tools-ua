...
// Перед добавлением событий, проверяем наличие элементов
...
var top3 = document.querySelector("#phone-3");
if (top3) {
  window.intlTelInput(top3, {
    initialCountry: "ua",
    dropdownContainer: document.body,
  });
}

var top4 = document.querySelector("#phone-4");
if (top4) {
  window.intlTelInput(top4, {
    initialCountry: "ua",
    dropdownContainer: document.body,
  });
}
