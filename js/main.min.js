...
!(function (e, t) {
  ...
  !(function () {
    ...
    function Q(e, t, d, n) {
      ...
      if (!n && (ae(t), (t = t || l), $)) {
        ...
        if (!(P[e + " "] || (f && f.test(e)))) {
          if (((u = e), (h = t), 1 === y && (B.test(e) || q.test(e)))) {
            for (
  ...
  function We(e, t, d, n) {
    ...
    if (
      ...
      for (a = (s = S.map(ke(i, "script"), Re)).length; u < $; u++)
        (l = i),
          u !== h &&
            ((l = S.clone(l, !0, !0)), a && S.merge(s, ke(l, "script"))),
          d.call(e[u], l, u);
      if (a)
        for (c = s[s.length - 1].ownerDocument, S.map(s, qe), u = 0; u < a; u++)
          (l = s[u]),
            Ce.test(l.type || "") &&
    ...
    function ye(e, t, d, n, i, o) {
      ...
      if (0 == s.length) r = 20;
        ...
        if (((s = new RegExp(r)), de(t), 0 == (r = t.toString()).search(s))) {
          ...
          a && null != a[1] && 0 < a[1].length && "0" == ie(a[1], R)
            ? (r = !1)
  ...
  (t = function () {
    ...
    var Ae,
      ...
      Ge = Le + "busy",
      Ke = Le + "atomic",
      Xe = [_e, Ie, "disabled", je, He, qe, Be, Fe, We, ze],
      Ye = Y,
      Ve = (Le = Y + "__") + "track",
      Ze = Le + "list",
      Je = Le + "slide",
    ...
    var At = "keydown",
      ...
      Dt = Object.freeze({
              ...
              var L = {
                ...
                mount: function () {
                  S ||
                    ...
                    D(n, ze, h.slide),
                    D(n, qe, w || se(h.slideLabel, [t + 1, e.length]))),
                    l(n, "click", i(a, fe, L)),
        ...
        Layout: function (e, t, d) {
          ...
          function S() {
            return X(d.height || q(h).width * d.heightRatio);
          }
          function x() {
            var e = X(d.gap);
            return (
          ...
          function T(e, t) {
            return (e = g(e || 0)) ? q(e.slide)[$("width")] + (t ? 0 : A()) : 0;
          }
          function k(e, t) {
            var d;
            return (e = g(e))
          ...
          return {
            ...
            move: function (e, t, d, i) {
              ...
              e !== t &&
                ((o = d < e),
                (a = h(w(T(), o))),
                o ? 0 <= a : a <= g[f("scrollWidth")] - q(v)[f("width")]) &&
                (S(), b(w(T(), d < e), !0)),
                s(4),
                r($e, t, d, e),
                n.start(t, function () {
        ...
        Autoplay: function (e, t, d) {
          ...
          function m() {
            p && (b(p, ct, !h), D(p, qe, d.i18n[h ? "play" : "pause"]));
          }
          function w(e) {
            (e = t.Slides.getAt(e)),
        ...
        Drag: function (e, t, d) {
          ...
          function R(e, t) {
            return (q(e) ? e.changedTouches[0] : e)["page" + T(t ? "Y" : "X")];
          }
          function q(e) {
        ...
        Pagination: function (e, t, o) {
          ...
          function E() {
            var e,
              t = k(g(!0)),
              d = k(g());
            t && (G((e = t.button), ct), O(e, Re), D(e, Ie, -1)),
              d && (w((e = d.button), ct), D(e, Re, !0), D(e, Ie, "")),
