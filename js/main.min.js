...
!(function (e, t) {
    ...
    S.each(
      {
        ...
        nextUntil: function (e, t, d) {
          return O(e, "nextSibling", d);
        },
        prevUntil: function (e, t, d) {
          return O(e, "previousSibling", d);
        },
        siblings: function (e) {
  ...
  (S.event = {
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Se.test(t.type) && t.click && C(t, "input") && Oe(t, "click", !0),
            !1
          );
        },
        trigger: function (e) {
    ...
    S.fn.extend({
      on: function (e, t, d, n) {
        return De(this, e, t, d, n);
      },
      one: function (e, t, d, n) {
        return De(this, e, t, d, n, 1);
      },
      off: function (e, t, d) {
        var n, i;
    ...
    var At = "keydown",
      ...
      Dt = Object.freeze({
        ...
        Direction: function (e, t, d) {
          return {
            resolve: function (e, t, n) {
              var i =
                "rtl" !== (n = n || d.direction) || t ? (n === De ? 0 : -1) : 1;
              return (
                (Oe[e] && Oe[e][i]) ||
                e.replace(/width|left|right/i, function (e, t) {
                  return (
                    (e = Oe[e.toLowerCase()][i] || e),
        ...
        Elements: function (e, t, n) {
          ...
          function v() {
            ...
            (c.id = e),
              (i.id = i.id || e + "-track"),
              (o.id = o.id || e + "-list"),
              !H(c, _e) && "SECTION" !== c.tagName && t && D(c, _e, t),
              D(c, ze, $.carousel),
              D(o, _e, "presentation"),
              S();
          }
            ...
            (d = (function (e, t, d, n) {
              ...
              function E() {
                ...
                o ||
                  ...
                  (i = !r && (!A() || S)),
                  e.state.is([4, 5]) || D(n, Fe, i || ""),
                  D(U(n, $.focusableNodes || ""), Ie, i ? -1 : ""),
                  v && D(n, Ie, i ? -1 : 0),
                  r !== q(n, pt) &&
              ...
              var L = {
                ...
                mount: function () {
                  S ||
                    ...
                    D(n, _e, g ? "tabpanel" : "group"),
                    D(n, ze, h.slide),
                    D(n, Re, w || se(h.slideLabel, [t + 1, e.length]))),
                    l(n, "click", i(a, fe, L)),
        ...
        Autoplay: function (e, t, d) {
          ...
          function m() {
            p && (b(p, ct, !h), D(p, Re, d.i18n[h ? "play" : "pause"]));
          }
          function w(e) {
            (e = t.Slides.getAt(e)),
            ...
            d($),
              t.Slides.forEach(function (e) {
                U(e.slide, Mt).forEach(function (t) {
                  ...
                  (d === t.src && i === t.srcset) ||
                    ((d = n.classes.spinner),
                    (d = k((i = t.parentElement), "." + d) || O("span", d, i)),
                    $.push([t, e, d]),
                    t.src || I(t, "none"));
                });
              }),
        ...
        Pagination: function (e, t, o) {
          ...
          function E() {
            var e,
              t = k(g(!0)),
              d = k(g());
            t && (G((e = t.button), ct), N(e, qe), D(e, Ie, -1)),
              d && (w((e = d.button), ct), D(e, qe, !0), D(e, Ie, "")),
          ...
          return {
            ...
            mount: function t() {
              ...
              if ((m && I(m, d ? "" : "none"), d)) {
                ...
                w(
                  (r = m || O("ul", n.pagination, p.track.parentElement)),
                  (s = ot + "--" + T())
                ),
                  D(r, _e, "tablist"),
                  D(r, Re, a.select),
                  D(r, We, T() === De ? "vertical" : "");
                for (var y = 0; y < v; y++) {
                  var A = O("li", null, r),
                    L = O("button", { class: n.page, type: "button" }, A),
        ...
        Sync: function (e, t, n) {
          ...
          function u() {
            D(t.Elements.list, We, n.direction === De ? "vertical" : "");
          }
          function $(t) {
            e.go(t.index);
          }
        ...
        Live: function (e, t, d) {
          var n = ke(e).on,
            ...
            a = Ee(90, i(l, !1));
          function l(e) {
            D(o, Ge, e), e ? (S(o, s), a.start()) : (B(s), a.cancel());
          }
          function c(e) {
            r && D(o, Ue, e ? "off" : "polite");
          }
          return {
            mount: function () {
              r &&
        ...
        return (
          (t.mount = function (e, t) {
            ...
            return (
              ...
              (this.t = e || this.t),
              A(L({}, Dt, this.t, { Transition: this.r }), function (e, t) {
...
function checkScreenWidthAndHandleTouch() {
  ...
  if (e >= 320 && e <= 951) {
    ...
    function t(e) {
      ...
      if (t.classList.contains("active")) {
        const d = t.querySelector(".cards__card-link-wrapper-my-link");
        d && (d.click(), e.preventDefault(), e.stopPropagation());
      } else
...
contact && redStarContact
  ...
  checkScreenWidthAndHandleTouch(),
  $(document).ready(function () {
