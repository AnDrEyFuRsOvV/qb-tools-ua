...
!(function (e, t) {
  ...
  !(function () {
    ...
    function Q(e, t, d, n) {
      ...
      if (!n && (ae(t), (t = t || l), $)) {
        ...
        if (!(P[e + " "] || (f && f.test(e)))) {
          if (((u = e), (h = t), 1 === y && (B.test(e) || R.test(e)))) {
            for (
            ...
            return 1 === n && 0 === i
              ...
              : function (t, d, a) {
                  ...
                  if (h) {
                    ...
                    if (((p = [r ? h.firstChild : h.lastChild]), r && m)) {
                      for (
                        b =
                          ($ =
                            (l = (c = h[v] || (h[v] = {}))[e] || [])[0] === y &&
      ...
      return (
        ...
        te(function (o, r, a, l) {
          var c,
            ...
            m = !e || (!o && t) ? y : fe(y, f, e, a, l);
          if (
            (d ? d(m, (p = i || (o ? e : v || n) ? [] : r), a, l) : (p = m), n)
          )
            ...
            var d = t.length > 0,
              ...
              r = function (r, s, a, c, u) {
                ...
                if (((v += m), d && m !== v)) {
                  ...
                  if (r) {
                    if (v > 0) for (; m--; ) b[m] || w[m] || (w[m] = T.call(c));
                    w = fe(w);
                  }
                  g.apply(c, w),
                    u &&
        ...
        if ((a = !S.isEmptyObject(t)) || !S.isEmptyObject(p))
          ...
          p))
            a ||
              ...
              h && me([e], !0),
              $.done(function () {
                for (n in (h || me([e]), ie.remove(e, "fxshow"), p))
                  S.style(e, n, p[n]);
              })),
              (a = gt(h ? g[n] : 0, n, $)),
              n in g ||
  ...
  S.extend(S.event, {
    trigger: function (t, d, n, i) {
      ...
      if (
        ...
        3 !== n.nodeType &&
          8 !== n.nodeType &&
          !Lt.test(y + S.event.triggered) &&
          (y.indexOf(".") > -1 &&
            ((m = y.split(".")), (y = m.shift()), m.sort()),
          (l = y.indexOf(":") < 0 && "on" + y),
          ((t = t[S.expando]
            ? t
            : new S.Event(y, "object" == typeof t && t)).isTrigger = i ? 2 : 3),
          (t.namespace = m.join(".")),
        ...
        if (!i && !$.noBubble && !h(n)) {
          for (
            a = $.delegateType || y, Lt.test(a + y) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            v.push(r), (s = r);
        ...
        return (
          ...
          i ||
            ...
            (l &&
              ...
              ((s = n[l]) && (n[l] = null),
              (S.event.triggered = y),
              t.isPropagationStopped() && p.addEventListener(y, Pt),
              n[y](),
              t.isPropagationStopped() && p.removeEventListener(y, Pt),
  ...
  (function () {
    ...
    function ne(e) {
      return null != e && (1 != y(e, 9) || -1 != v(e, 9)[0]);
    }
    function ie(e, t) {
    ...
    function pe(e, t) {
      var d = e.length;
      return !(0 < y(t, 9) && -1 == v(t, 9).indexOf(d)) && Se(g(t, 2), e);
    }
    function fe(e, t) {
      if (null == t) return null;
      var d = g(t, 1);
    ...
    function ge(e, t, d, n) {
      var i = ce(d, n),
        o = 0 == y(i, 9) ? v(h(d, 1), 9) : v(i, 9);
      if (((i = v(i, 10)), 2 == n)) {
        if (!ne(ce(d, 0))) return ge(e, t, d, 1);
        ne((e = ce(d, 1))) &&
          ((o = o.concat(0 == y(e, 9) ? v(h(d, 1), 9) : v(e, 9))).sort(),
    ...
    function we(e, t, d, n) {
      ...
      try {
        ...
        if (0 == (s = ye(e, (a = a.replace(B, "")), r, t, n, o))) throw d;
      }
      if (
        (0 != s
          ? (i = he(s)) != d && (r = se(e, s, i))
      ...
      if (
        (null != r &&
          ((d = new k()),
          me((i = new k(t.toString())), r, d),
          2 != (e = ge(e, i.toString(), r, -1)) &&
            4 != e &&
            5 != e &&
            ((t = i), n && 0 < d.toString().length && m(o, 7, d.toString()))),
    ...
    var At = "keydown",
      ...
      Ot = Object.freeze({
          ...
          function L(e) {
            return p.filter(
              u(e)
                ? e
                : function (t) {
                    return $(e) ? C(t.slide, e) : y(g(e), t.index);
                  }
            );
          }
          return {
          ...
          function u() {
            if ((r(he, $), r([ge, ve], h), (i = g()))) {
              var d = i,
                ...
                l = o.length;
              if (l) {
                for (; o.length < d; ) m(o, o);
                m(o.slice(-d), o.slice(0, d)).forEach(function (t, i) {
                  var r = i < d,
                    u = (function (t, d) {
                      return (
        ...
        Move: function (e, t, d) {
          ...
          function y() {
            t.Controller.isBusy() ||
              (t.Scroll.cancel(), m(e.index), t.Slides.update());
          }
          function m(e) {
            b(C(e, !0));
          }
          ...
          return {
            mount: function () {
              (n = t.Transition), o([ue, ye, ge, he], y);
            },
        ...
        Controller: function (e, t, d) {
          var n,
            ...
            T = C;
          function k() {
            (o = y(!0)), (r = d.perMove), (s = d.perPage), (n = M());
            var e = oe(C, 0, m ? n : o - 1);
        ...
        Arrows: function (e, t, d) {
          ...
          function A() {
            ...
            v &&
              ...
              O(v, Re, n),
              O(y, Re, i),
              l("arrows:updated", v, y, t, d));
          }
          return { arrows: m, mount: b, destroy: T, update: A };
        },
        Autoplay: function (e, t, d) {
          ...
          function g() {
            c() &&
              t.Slides.isEnough() &&
              (l.start(!d.resetProgress), (i = n = h = !1), m(), a(xe));
          }
          function v(e) {
            (h = !!(e = void 0 === e || e)), m(), c() || (l.pause(), a(Ce));
          }
          function y() {
            h || (n || i ? v(!1) : g());
          }
        ...
        Drag: function (e, t, d) {
          ...
          function N(t) {
            var i, o, r, s, u;
            y.is(6) || (y.set(6), h("drag")),
              t.cancelable &&
                (a
                  ? (m.translate(n + I(t) / (L && e.is(wt) ? 5 : 1)),
                    (u = 200 < j(t)),
                    (i = L !== (L = A())),
                    (u || i) && _(t),
                    (c = !0),
        ...
        Pagination: function (e, t, o) {
          var r,
            ...
            b = [];
          function S() {
            r && (B(m ? n(r.children) : r), G(r, s), d(b), (r = null)),
              a.destroy();
          }
          function x(e) {
            v(">" + e, !0);
          ...
          return {
            ...
            mount: function t() {
              ...
              if ((m && I(m, d ? "" : "none"), d)) {
                ...
                w(
                  (r = m || D("ul", n.pagination, p.track.parentElement)),
                  (s = ot + "--" + T())
                ),
                  O(r, _e, "tablist"),
                  O(r, Re, a.select),
                ...
                for (var y = 0; y < v; y++) {
                  var A = D("li", null, r),
                    ...
                    P = $.getIn(y).map(function (e) {
                      return e.slide.id;
                    }),
                    M = !h() && 1 < g ? a.pageX : a.slideX;
                  u(L, "click", i(x, y)),
                    o.paginationKeyboard && u(L, "keydown", i(C, y)),
                    O(A, _e, "presentation"),
                    O(L, _e, "tab"),
                    O(L, je, P.join(" ")),
                    O(L, Re, se(M, y + 1)),
                    O(L, Ie, -1),
                    b.push({ li: A, button: L, page: y });
                }
...
function checkScreenWidthAndHandleClick() {
  const e = window.innerWidth;
  e >= 320 &&
    e <= 951 &&
    (document
      .querySelectorAll(".cards__card-link-wrapper-my-link")
      .forEach((e) => {
        e.addEventListener("click", () => {
          event.preventDefault();
        });
      }),
    document.querySelectorAll(".cards__card").forEach((e) => {
      e.addEventListener("click", () => {
        e.classList.add("active"),
          e
            .querySelector(".cards__card-link-wrapper-my-link")
            .classList.add("active");
      });
    }),
    document
      .querySelectorAll(".cards__card-link-wrapper-my-link.active")
      .forEach((e) => {
        e.href = e.href;
      }),
    document.querySelectorAll(".cards__card").forEach((e) => {
...
contact && redStarContact
  ...
  checkScreenWidthAndHandleClick(),
  $(document).ready(function () {
