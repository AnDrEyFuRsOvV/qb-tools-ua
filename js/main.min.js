...
function checkScreenWidthAndHandleClick() {
  ...
  if (e >= 320 && e <= 951) {
    const d = document.querySelectorAll(".cards__card");
    function t(e) {
      const t = e.currentTarget;
      if (t.classList.contains("active")) {
        const e = t.querySelector(".cards__card-link-wrapper-my-link");
        e && e.click();
      } else
        e.preventDefault(),
    ...
    console.log("Ширина экрана не попадает в диапазон от 320 до 951 пикселей.");
}
function onEntry(e) {
  e.forEach((e) => {
