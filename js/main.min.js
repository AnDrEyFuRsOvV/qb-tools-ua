...
function toggleCard(e) {
  ...
  activeCard === t
    ? t.classList.contains("active")
      ? isMobile && !isLinkAllowed && (isLinkAllowed = !0)
      : (t.classList.add("active"), (isLinkAllowed = !isMobile))
    : (activeCard && activeCard.classList.remove("active"),
      t.classList.add("active"),
      (activeCard = t),
      (isLinkAllowed = !1)),
    isMobile && !isLinkAllowed && e.preventDefault();
}
function handleCardClick(e) {
  isMobile ? handleTouchStart(e) : toggleCard(e);
}
function handleTouchStart(e) {
  const t = e.currentTarget;
  activeCard === t && isMobile && !isLinkAllowed
    ? (isLinkAllowed = !0)
    : toggleCard(e);
}
function checkScreenSize() {
  isMobile = window.innerWidth <= 950 && window.innerWidth >= 320;
}
function onEntry(e) {
  e.forEach((e) => {
