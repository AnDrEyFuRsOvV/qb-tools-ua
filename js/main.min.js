...
!(function (e, t) {
  ...
  !(function () {
    ...
    try {
      g.apply((d = i.call(O.childNodes)), O.childNodes),
        d[O.childNodes.length].nodeType;
    } catch (e) {
      g = {
        apply: function (e, t) {
          D.apply(e, i.call(t));
          ...
          (M = function (e, t) {
            ...
            return (
              ...
              (!p.sortDetached && t.compareDocumentPosition(e) === d)
                ? e === l || (e.ownerDocument == O && Q.contains(O, e))
                  ? -1
                  : t === l || (t.ownerDocument == O && Q.contains(O, t))
                  ? 1
                  : r
    ...
    S.each(
      {
        ...
        nextUntil: function (e, t, d) {
          return N(e, "nextSibling", d);
        },
        prevUntil: function (e, t, d) {
          return N(e, "previousSibling", d);
        },
        siblings: function (e) {
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            Se.test(t.type) && t.click && C(t, "input") && Ne(t, "click", !0),
            !1
          );
        },
        trigger: function (e) {
  ...
  (t = function () {
    ...
    function D(e, t, d) {
      l(t)
        ...
        : v(e, function (e) {
            f(d) || "" === d ? O(e, t) : e.setAttribute(t, String(d));
          });
    }
    function N(e, t, d) {
      return (
    ...
    var Ct = V + "-interval",
      ...
      kt = { Spacebar: " ", Right: Me, Left: Pe, Up: Oe, Down: Ae };
    function Et(e) {
      ...
      Dt = Object.freeze({
        ...
        Elements: function (e, t, n) {
          ...
          function y(e) {
            ...
            d(f), G(c, h), G(i, g), O([i, o], t), O(c, e ? t : ["style", ze]);
          }
          function S() {
            G(c, h),
              G(i, g),
            ...
            d($),
              t.Slides.forEach(function (e) {
                U(e.slide, Mt).forEach(function (t) {
                  ...
                  (d === t.src && i === t.srcset) ||
                    ((d = n.classes.spinner),
                    (d = k((i = t.parentElement), "." + d) || N("span", d, i)),
                    $.push([t, e, d]),
                    t.src || I(t, "none"));
                });
              }),
        ...
        Pagination: function (e, t, o) {
          ...
          function E() {
            var e,
              t = k(g(!0)),
              d = k(g());
            t && (G((e = t.button), ct), O(e, qe), D(e, Ie, -1)),
          ...
          return {
            ...
            mount: function t() {
              ...
              if ((m && I(m, d ? "" : "none"), d)) {
                ...
                w(
                  (r = m || N("ul", n.pagination, p.track.parentElement)),
                  (s = ot + "--" + T())
                ),
                  D(r, _e, "tablist"),
                  D(r, Re, a.select),
                ...
                for (var y = 0; y < v; y++) {
                  var A = N("li", null, r),
                    L = N("button", { class: n.page, type: "button" }, A),
...
firstSliderElement &&
  ...
  document.addEventListener("DOMContentLoaded", function () {
    const e = document.querySelector(".slick-slider");
